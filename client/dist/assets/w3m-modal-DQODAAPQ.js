import{p as ve,q as fe,s as ge,t as be,M as g,u as re,R as l,i as v,r as P,a as f,b as a,v as K,e as ce,o as le,j as m,f as Y,k as ye,x as S,E as ie,O as E,C as q,y as oe,l as T,A as H,T as xe,z as Ce,c as ke,h as Se}from"./core-DkGGPiq9.js";import{c as u,n as w,r as d,o as F,U as We}from"./index-BgngkEvV.js";import"./index-C1pl6iOY.js";const p=fe({message:"",open:!1,triggerRect:{width:0,height:0,top:0,left:0},variant:"shade"}),Re={state:p,subscribe(s){return be(p,()=>s(p))},subscribeKey(s,e){return ge(p,s,e)},showTooltip({message:s,triggerRect:e,variant:t}){p.open=!0,p.message=s,p.triggerRect=e,p.variant=t},hide(){p.open=!1,p.message="",p.triggerRect={width:0,height:0,top:0,left:0}}},O=ve(Re),de={isUnsupportedChainView(){return l.state.view==="UnsupportedChain"||l.state.view==="SwitchNetwork"&&l.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){g.shake();return}if(await re.isSIWXCloseDisabled()){g.shake();return}g.close()}},$e=v`
  :host {
    display: block;
